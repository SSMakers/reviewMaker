...
Codex CLI는 로컬에 설치되어 있어야 합니다.

```text
codex exec -C /Users/kwanghyukan/Desktop/KHAN/SW/Project/reviewMaker/pythonProject --sandbox workspace-write --ask-for-approval never "<prompt>"
```
